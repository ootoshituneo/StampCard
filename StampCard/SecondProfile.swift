...
//  StampCard
//
//  Created by Tsuneo Ootoshi on 2018/02/05.
...
class SecondProfile: UIViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func QRPressed(_ sender: UISwitch) {
        if(sender.isOn){
